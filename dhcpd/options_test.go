...
func newTestDB(t *testing.T, group models.Group) *models.Host {
	t.Helper()
	...
	if err := db.DB.AutoMigrate(&models.Host{}, &models.Option{}, &models.DeviceClass{}, &models.Group{}, &models.Image{}); err != nil {
