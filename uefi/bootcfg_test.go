...
func setup(t *testing.T, group models.Group, host models.Host) (models.Host, models.Image, *config.Config) {
	t.Helper()
	...
	if err := db.DB.AutoMigrate(&models.Host{}, &models.Group{}, &models.Image{}); err != nil {
	...
	image := models.Image{ImageForm: models.ImageForm{Path: dir}}
	if res := db.DB.Create(&image); res.Error != nil {
...
func render(t *testing.T, group models.Group, host models.Host) string {
	t.Helper()
