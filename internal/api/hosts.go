...
// @Accept  json
// @Produce  json
// @Param item body model.Host true "Fields to search for"
// @Success 200 {object} model.Host
// @Failure 400 {object} model.APIError
// @Failure 404 {object} model.APIError
// @Failure 500 {object} model.APIError
...
// @Accept  json
// @Produce  json
// @Param item body model.HostForm true "Add a host"
// @Success 200 {object} model.Host
// @Failure 400 {object} model.APIError
// @Failure 500 {object} model.APIError
// @Router /hosts [post]
func CreateHost(c *gin.Context) {
	var form model.HostForm
	...
	item := model.Host{HostForm: form}

	var group model.Group
	if res := store.DB.First(&group, "id = ?", form.GroupID); res.Error != nil {
		Error(c, http.StatusInternalServerError, res.Error) // 500
		return
	}
...
// @Produce  json
// @Param  id path int true "Host ID"
// @Param  item body model.HostForm true "Update a host"
// @Success 200 {object} model.Host
// @Failure 400 {object} model.APIError
// @Failure 404 {object} model.APIError
// @Failure 500 {object} model.APIError
...
func UpdateHost(c *gin.Context) {
	...
	if err := mergo.Merge(&item, model.Host{HostForm: form}, mergo.WithOverride); err != nil {
